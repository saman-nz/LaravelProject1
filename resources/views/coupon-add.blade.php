...
<div class="head success-bg clearfix">
  ...
  <div class="functions-btns pull-right"> <a class="refresh-btn" href="#"><i class="zmdi zmdi-refresh"></i></a> <a class="fullscreen-btn" href="#"><i class="zmdi zmdi-fullscreen"></i></a>
...
<div class="row">
  <div class="form-group">
    ...
    <div class="col-sm-5 p-r-30">
      <input type="text" class="form-control material" id="store_name" placeholder="category title">
    </div>
  </div>
   <div class="form-group">
    <label for="store_name" class="col-sm-1 control-label">Meta Title</label>
    <div class="col-sm-5 p-r-30">
      <input type="text" class="form-control material" id="store_name" placeholder="meta title">
    </div>
  </div>
</div>
<div class="row">
  <div class="form-group">
    <label for="store_url" class="col-sm-1 control-label">Meta Description</label>
    <div class="col-sm-5">
      <input type="text" class="form-control material" id="store_url" placeholder="meta description">
    </div>
  </div>
   <div class="form-group">
    ...
    <div class="col-sm-2 p-t-15">
      <label>
        <input class="toggle toggle-info" type="checkbox" >
        <i></i></label>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-2 p-t-15">
      <label>
        <input class="toggle toggle-info" type="checkbox" checked>
        <i></i></label>
    </div>
  </div>
</div>
...
<!-- Row -->
                ...
                <div class="form-group">
                  <div class="col-sm-12 text-right">
                    ...
                    <button type="button" class="btn btn-primary m-b-5 m-l-30">Save</button>
                  </div>
                </div>
                </div> <!------ Row ----->
